...
function renderWarnings(data: ThreadsDashboardData): string {
  ...
  if (!data.connected) warnings.push("Bridgeに接続できません。実値は表示せず、接続待ちにしています。");
