...
export const THREADS_ACTIVITY_EVENT_TYPES = Object.freeze([
  "insights_collected",
  "baseline_cta_declared",
  "editorial_cycle_waiting",
  "editorial_experiment_decided",
  "editorial_draft_ready",
  "editorial_cycle_approved",
  "experiment_observation_ready",
...
function validateEventState(event: ThreadsActivityEvent): void {
  const fixed: Partial<Record<ThreadsActivityEventType, readonly [readonly DecisionStatus[], readonly ResultStatus[]]>> = {
    ...
    baseline_cta_declared: [["not_applicable"], ["succeeded"]],
    ...
    editorial_cycle_approved: [["approved"], ["succeeded"]],
    experiment_observation_ready: [["not_applicable"], ["succeeded"]],
    experiment_evaluated: [["approved", "rejected", "blocked", "unknown"], ["succeeded", "blocked", "unknown"]],
    experiment_inconclusive: [["unknown"], ["unknown"]],
    learning_outcome_recorded: [["not_applicable"], ["succeeded"]],
    next_experiment_selected: [["approved"], ["succeeded"]],
    experiment_completed: [["not_applicable"], ["succeeded"]],
